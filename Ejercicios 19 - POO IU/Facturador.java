...
public class Facturador extends JFrame{
	...
	public void initComponent(){
		...
		*/
		...
		KeyListener eventoKey_cliente = new KeyListener(){
		...
		input_cedula_cliente.addKeyListener( eventoKey_cliente );

		KeyListener eventoKey_vendedor = new KeyListener(){
			public void keyPressed(KeyEvent e){
			}
		...
		input_cedula_vendedor.addKeyListener( eventoKey_vendedor );

		KeyListener eventoKey_Producto = new KeyListener(){
			public void keyPressed(KeyEvent e){
			}
		...
		input_id_producto.addKeyListener( eventoKey_Producto );

		KeyListener eventoKey_Producto_ = new KeyListener(){
			public void keyPressed(KeyEvent e){
			}
		...
		input_cant_producto.addKeyListener( eventoKey_Producto_ );
	...
	public void desHabilitarInput(JTextField campo){
		...
		campo.setBackground(new Color(238,238,238,238));
	...
	public void agregarProducto(){
		int cant = Integer.parseInt(input_cant_producto.getText());
		int costo_individual = listaProductos[indice_agregar].getPrecio() * cant;
		totalFactura = totalFactura + costo_individual;

		String text = " => "+listaProductos[indice_agregar].getNombre()+" x "+cant+" = "+costo_individual;
